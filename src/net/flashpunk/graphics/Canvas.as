package net.flashpunk.graphics 
{
	...
	public class Canvas extends Graphic
	{
		...
		public function changeColor(fromColor:uint,toColor:uint,mask:uint):void
		{
			for each(var buffer:BitmapData in _buffers)
			{
				var rectangle:Rectangle = new Rectangle(0, 0, buffer.width, buffer.height);
				buffer.threshold(buffer, rectangle, new Point(0, 0), "==", fromColor, toColor, mask, true);
			}
		}
		...
		/** @private */ public var _ref:BitmapData;
